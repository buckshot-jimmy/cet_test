...
use App\Controller\ConsultatieController;
...
class ConsultatieControllerTest extends WebTestCase
{
    protected function setUp(): void
    {
        ...
        $this->consultatiiService = $this->createMock(ConsultatieService::class);
        $this->authorizationChecker = $this->createMock(AuthorizationCheckerInterface::class);

        $this->controller = new ConsultatieController(
            $this->em,
            $this->translator,
    ...
    /**
     * @covers \App\Controller\ConsultatieController::__construct
     */
    public function testCanBuildController()
    {
        $controller = new ConsultatieController(
            $this->em, $this->translator, $this->consultatiiService, $this->authorizationChecker
        );

        $this->assertInstanceOf(ConsultatieController::class, $controller);
    }

    /**
     * @covers \App\Controller\ConsultatieController::consultatii
     */
    public function testConsultatiiAccessDeniedForView(): void
    {
        $this->authorizationChecker
            ->method('isGranted')
            ->with('VIEW', $this->isInstanceOf(Consultatie::class))
            ->willReturn(false);
    ...
    public function testRendersConsultatiiTemplateWithCorrectData(): void
    {
        ...
        $mediciTrimitatoriRepo = $this->createMock(MedicTrimitatorRepository::class);
        ...
        $this->em->method('getRepository')->willReturnMap([
            ...
            [MedicTrimitator::class, $mediciTrimitatoriRepo],
        ]);
    ...
    /**
     * @covers \App\Controller\ConsultatieController::listConsultatiiCurenteCabinet
     */
    ...
    public function testItCanReturnListConsultatiiCurenteCabinet(): void
    {
        ...
        $roleMock->method('getDenumire')
            ->willReturn(ConsultatieController::ROL_MEDIC);
    ...
    /**
     * @covers \App\Controller\ConsultatieController::cabinet
     */
    ...
    public function testItCanRenderConsultatiiCurenteCabinet(): void
    {
        ...
        $controller = $this->getMockBuilder(ConsultatieController::class)
    ...
    /**
     * @covers \App\Controller\ConsultatieController::stergeConsultatie
     */
    public function testConsultatiiAccessDeniedForDelete(): void
    {
        $this->authorizationChecker
            ->method('isGranted')
            ->with('DELETE', $this->isInstanceOf(Consultatie::class))
            ->willReturn(false);
    ...
    /**
     * @covers \App\Controller\ConsultatieController::getConsultatieInvestigatieEvaluare
     */
    ...
    /**
     * @covers \App\Controller\ConsultatieController::salveazaConsultatie
     */
    public function testConsultatiiAccessDeniedForEditCons(): void
    {
        ...
        $this->consRepo->expects($this->once())
            ->method('findOneBy')
            ->with(['id' => '10'])
            ->willReturn(new Consultatie());

        $this->client->loginUser($this->testUser, 'main');

        $dto = $this->createMock(ConsultatieDTO::class);
    ...
    /**
     * @covers \App\Controller\ConsultatieController::salveazaInvestigatie
     */
    ...
    /**
     * @covers \App\Controller\ConsultatieController::salveazaEvaluarePsihologica
     */
    ...
    /**
     * @covers \App\Controller\ConsultatieController::getIstoricPacient
     */
    ...
    /**
     * @covers \App\Controller\ConsultatieController::pdfServiciiFormulare
     */
    ...
    /**
     * @covers \App\Controller\ConsultatieController::inchideDeschide
     */
    ...
    /**
     * @covers \App\Controller\ConsultatieController::getConsultatiiPeLuni
     */
    ...
    /**
     * @covers \App\Controller\ConsultatieController::getIncasariMedicPeLuni
     */
