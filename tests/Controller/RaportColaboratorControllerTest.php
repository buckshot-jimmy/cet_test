...
use App\Controller\RaportColaboratorController;
...
class RaportColaboratorControllerTest extends WebTestCase
{
    protected function setUp(): void
    {
        ...
        $this->controller = new RaportColaboratorController(
            $this->em,
            $this->translator,
        ...
        $this->rapoarteRepo = $this->createMock(RaportColaboratorRepository::class);
        ...
        $this->controllerMock = $this->getMockBuilder(RaportColaboratorController::class)
    ...
    /**
     * @covers \App\Controller\RaportColaboratorController::__construct
     */
    public function testCanBuildController()
    {
        $controller = new RaportColaboratorController(
            $this->em,
            $this->translator,
            $this->authorizationChecker
        );

        $this->assertInstanceOf(RaportColaboratorController::class, $controller);
    }

    /**
     * @covers \App\Controller\RaportColaboratorController::rapoarte
     */
    public function testViewRapoarteWithAccessDenied()
    {
        ...
        $this->authorizationChecker
            ->method('isGranted')
            ->with('VIEW', $this->isInstanceOf(RaportColaborator::class))
            ->willReturn(false);
    ...
    /**
     * @covers \App\Controller\RaportColaboratorController::listRapoarteColaboratori
     */
    ...
    /**
     * @covers \App\Controller\RaportColaboratorController::saveRapoarteColaboratori
     */
    public function testSaveRaportWithAccessDenied()
    {
        ...
        $this->authorizationChecker
            ->method('isGranted')
            ->with('ADD_EDIT', $this->isInstanceOf(RaportColaborator::class))
            ->willReturn(false);
    ...
    /**
     * @covers \App\Controller\RaportColaboratorController::calculeazaPlataColaborator
    ...
    public function testCalculeazaPlataColaborator($stare, $totalDePlata, $message)
    {
        ...
        $this->em->method('getRepository')->willReturnMap([
            [RaportColaborator::class, $this->rapoarteRepo],
            [Consultatie::class, $this->consRepo],
        ]);
    ...
    /**
     * @covers \App\Controller\RaportColaboratorController::platesteColaborator
     */
    ...
    /**
     * @covers \App\Controller\RaportColaboratorController::pdf
     */
    ...
    /**
     * @covers \App\Controller\RaportColaboratorController::plataColaborator
     */
    ...
    /**
     * @covers \App\Controller\RaportColaboratorController::getColaboratoriOwner
     */
