...
use App\Controller\ProgramareController;
...
class ProgramareControllerTest extends WebTestCase
{
    protected function setUp(): void
    {
        ...
        $this->controller = new ProgramareController(
            $this->em,
            $this->translator,
            $this->validator,
            $this->constraint,
        ...
        $this->controllerMock = $this->getMockBuilder(ProgramareController::class)
        ...
        $this->pret = $this->dbEm->getRepository(Pret::class)->findAll()[0];
        ...
        $this->pacient = $this->dbEm->getRepository(Pacient::class)->find($this->pacient->getId());
        $this->pret = $this->dbEm->getRepository(Pret::class)->find($this->pret->getId());
    }
    ...
    /**
     * @covers \App\Controller\ProgramareController::__construct
     */
    public function testCanBuildController()
    {
        $controller = new ProgramareController(
            $this->em, $this->translator, $this->validator, $this->constraint, $this->adminService,
            $this->authorizationChecker
        );

        $this->assertInstanceOf(ProgramareController::class, $controller);
    }

    /**
     * @covers \App\Controller\ProgramareController::programari
     */
    ...
    /**
     * @covers \App\Controller\ProgramareController::list
     */
    public function testItCanReturnListAllProgramari(): void
    {
        ...
        $roleMock->method('getDenumire')
            ->willReturn(ProgramareController::ROL_MEDIC);
    ...
    /**
     * @covers \App\Controller\ProgramareController::adaugaProgramare
     */
    public function testEditProgramareWithAccessDenied(): void
    {
        $this->authorizationChecker
            ->method('isGranted')
            ->with('ADD', $this->isInstanceOf(Programare::class))
            ->willReturn(false);
    ...
    public function testProgramariCanShowValidationErrorsFromEdit(): void
    {
        $this->authorizationChecker
            ->method('isGranted')
            ->with('EDIT', $this->isInstanceOf(Programare::class))
            ->willReturn(true);
        ...
        $this->em->method('getRepository')
            ->with(Programare::class)
            ->willReturn($this->repo);

        $this->repo->expects($this->once())
            ->method('findOneBy')
            ->with(['id' => '10'])
            ->willReturn(new Programare());
    ...
    /**
     * @covers \App\Controller\ProgramareController::getProgramare
     */
    ...
    /**
     * @covers \App\Controller\ProgramareController::anuleazaProgramare
     */
    public function testProgramareAccessDeniedForCancel(): void
    {
        ...
        $this->authorizationChecker
            ->method('isGranted')
            ->with('CANCEL', $this->isInstanceOf(Programare::class))
            ->willReturn(false);
    ...
    /**
     * @covers \App\Controller\ProgramareController::pacientAnuleazaProgramare
     */
    ...
    public function testSubmitPacientAnuleazaProgramareInvalidToken(): void
    {
        ...
        $controller = $this->getMockBuilder(ProgramareController::class)
            ->setConstructorArgs([
                $this->em,
                $this->translator,
                $this->validator,
    ...
    public function testPacientAnuleazaProgramareSuccessValidToken()
    {
        ...
        $repo = $this->createMock(ProgramareRepository::class);
    ...
    /**
     * @covers \App\Controller\ProgramareController::verificaDisponibilitate
     */
    ...
    /**
     * @covers \App\Controller\ProgramareController::trimiteEmailProgramare
     */
