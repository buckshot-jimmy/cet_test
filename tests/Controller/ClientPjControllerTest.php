...
use App\Controller\ClientPjController;
...
class ClientPjControllerTest extends WebTestCase
{
    protected function setUp(): void
    {
        ...
        $this->controller = new ClientPjController(
            $this->em,
            $this->validator,
        ...
        $this->controllerMock = $this->getMockBuilder(ClientPjController::class)
        ...
        $this->repo = $this->createMock(PersoanaJuridicaRepository::class);
    ...
    /**
     * @covers \App\Controller\ClientPjController::__construct
     */
    public function testCanBuildController()
    {
        $controller = new ClientPjController(
            $this->em,
            $this->validator,
            $this->firmeConstraint,
            $this->translator,
        ...
        $this->assertInstanceOf(ClientPjController::class, $controller);
    }

    /**
     * @covers \App\Controller\ClientPjController::clientiPj
     */
    ...
    public function testRendersClientiWithAccessDenied(): void
    {
        $this->authorizationChecker
            ->method('isGranted')
            ->with('VIEW', $this->isInstanceOf(PersoanaJuridica::class))
            ->willReturn(false);
    ...
    /**
     * @covers \App\Controller\ClientPjController::list
     */
    ...
    /**
     * @covers \App\Controller\ClientPjController::salveazaClientPj
     */
    ...
    /**
     * @covers \App\Controller\ClientPjController::getClientPj
     */
    ...
    /**
     * @covers \App\Controller\ClientPjController::sterge
     */
    public function testClientAccessDeniedForDelete(): void
    {
        $this->authorizationChecker
            ->method('isGranted')
            ->with('DELETE', $this->isInstanceOf(PersoanaJuridica::class))
            ->willReturn(false);
    ...
    public function testPacientiCanBeDeleted(): void
    {
        ...
        $this->em->method('getRepository')->willReturnMap([
            [PersoanaJuridica::class, $this->repo],
        ]);
    ...
    /**
     * @covers \App\Controller\ClientPjController::getClientiPjByCui
     */
