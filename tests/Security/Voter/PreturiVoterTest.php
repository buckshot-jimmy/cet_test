...
use App\Entity\Role;
use App\Entity\User;
use App\Security\Voter\PreturiVoter;
use PHPUnit\Framework\TestCase;
use Symfony\Component\Security\Core\Authentication\Token\TokenInterface;

class PreturiVoterTest extends TestCase
{
    private $token;

    public function setUp(): void
    {
        $this->voter = new PreturiVoter();

        $this->token = $this->createMock(TokenInterface::class);

        $this->mock = $this->getMockBuilder(PreturiVoter::class)
    ...
    /**
     * @covers \App\Security\Voter\PreturiVoter::supports
     */
    ...
    /**
     * @covers \App\Security\Voter\PreturiVoter::voteOnAttribute
     */
    public function testVoteOnAttributeWithRoleTest()
    {
        ...
        $result = $this->voter->vote($this->token, new Preturi(), ['ADD_EDIT']);
    ...
    public function testVoteOnAttribute($attribute)
    {
        ...
        $result = $this->voter->vote($this->token, new Preturi(), [$attribute]);
    ...
    public function testVoteOnAttributeWithNotAttribute()
    {
        ...
        $this->mock->method('supports')->with('None', new Preturi())->willReturn(true);

        $result = $this->mock->vote($this->token, new Preturi(), ['None']);
