...
class PretVoterTest extends TestCase
{
    private $token;

    public function setUp(): void
    {
        $this->voter = new PretVoter();

        $this->token = $this->createMock(TokenInterface::class);

        $this->mock = $this->getMockBuilder(PretVoter::class)
    ...
    /**
     * @covers \App\Security\Voter\PretVoter::supports
     */
    ...
    /**
     * @covers \App\Security\Voter\PretVoter::voteOnAttribute
     */
    public function testVoteOnAttributeWithRoleTest()
    {
        ...
        $result = $this->voter->vote($this->token, new Pret(), ['ADD_EDIT']);
    ...
    public function testVoteOnAttribute($attribute)
    {
        ...
        $result = $this->voter->vote($this->token, new Pret(), [$attribute]);
    ...
    public function testVoteOnAttributeWithNotAttribute()
    {
        ...
        $this->mock->method('supports')->with('None', new Pret())->willReturn(true);

        $result = $this->mock->vote($this->token, new Pret(), ['None']);
