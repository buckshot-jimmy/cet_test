...
use App\Entity\Role;
use App\Entity\User;
use App\Security\Voter\PacientVoter;
use PHPUnit\Framework\TestCase;
use Symfony\Component\Security\Core\Authentication\Token\TokenInterface;

class PacientVoterTest extends TestCase
{
    private $token;

    public function setUp(): void
    {
        $this->voter = new PacientVoter();

        $this->token = $this->createMock(TokenInterface::class);

        $this->mock = $this->getMockBuilder(PacientVoter::class)
    ...
    /**
     * @covers \App\Security\Voter\PacientVoter::supports
     */
    ...
    /**
     * @covers \App\Security\Voter\PacientVoter::voteOnAttribute
     */
    public function testVoteOnAttributeWithRoleTest()
    {
        ...
        $result = $this->voter->vote($this->token, new Pacient(), ['ADD_EDIT']);
    ...
    public function testVoteOnAttribute($attribute)
    {
        ...
        $result = $this->voter->vote($this->token, new Pacient(), [$attribute]);
    ...
    public function testVoteOnAttributeWithNotAttribute()
    {
        ...
        $this->mock->method('supports')->with('None', new Pacient())->willReturn(true);

        $result = $this->mock->vote($this->token, new Pacient(), ['None']);
