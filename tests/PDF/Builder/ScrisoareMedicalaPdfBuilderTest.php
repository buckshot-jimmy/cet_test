...
class ScrisoareMedicalaPdfBuilderTest extends KernelTestCase
{
    public function setUp(): void
    {
        ...
        $this->builder = new ScrisoareMedicalaPdfBuilder($this->em);
    }
    ...
    /**
     * @covers \App\PDF\Builder\ScrisoareMedicalaPdfBuilder::__construct
     */
    public function testCanBuildBuilder()
    {
        $this->assertInstanceOf(ScrisoareMedicalaPdfBuilder::class, $this->builder);
    }

    /**
     * @covers \App\PDF\Builder\ScrisoareMedicalaPdfBuilder::getSupportedTemplates
     */
    public function testReturnsSupportedTemplate()
    {
        ...
        $this->assertSame('scrisoare_medicala.html.twig', $template);
    }

    /**
     * @covers \App\PDF\Builder\ScrisoareMedicalaPdfBuilder::build
     */
