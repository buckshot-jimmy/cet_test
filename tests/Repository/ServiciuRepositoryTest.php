...
class ServiciuRepositoryTest extends KernelTestCase
{
    protected function setUp(): void
    {
        ...
        $this->repo = new ServiciuRepository($registry, $this->em);
    ...
    /**
     * @covers \App\Repository\ServiciuRepository::__construct
     */
    public function testCanBuildServiciiRepository()
    {
        $this->assertInstanceOf(ServiciuRepository::class, $this->repo);
    }

    /**
     * @covers \App\Repository\ServiciuRepository::getAllServicii
     */
    public function testItCanGetAllServiciiWithException()
    {
        ...
        $repoMock = $this->getMockBuilder(ServiciuRepository::class)
    ...
    /**
     * @covers \App\Repository\ServiciuRepository::saveServiciu
     */
    public function testItCanSaveServiciuWithException()
    {
        ...
        $repo = new ServiciuRepository($registry, $em);
