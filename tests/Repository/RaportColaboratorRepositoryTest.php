...
class RaportColaboratorRepositoryTest extends WebTestCase
{
    protected function setUp(): void
    {
        ...
        $this->repo = new RaportColaboratorRepository($registry, $this->em, $this->service);
    ...
    /**
     * @covers \App\Repository\RaportColaboratorRepository::__construct
     */
    public function testCanBuildRapoarteRepository()
    {
        $this->assertInstanceOf(RaportColaboratorRepository::class, $this->repo);
    }

    /**
     * @covers \App\Repository\RaportColaboratorRepository::getAllRapoarteColaboratori
     */
    public function testCanGetAllRapoarteWithException()
    {
        ...
        $repoMock = $this->getMockBuilder(RaportColaboratorRepository::class)
    ...
    /**
     * @covers \App\Repository\RaportColaboratorRepository::getAllRapoarteColaboratori
     * @covers \App\Repository\RaportColaboratorRepository::getTotalRapoarte
     * @covers \App\Repository\RaportColaboratorRepository::applyFilters
     * @covers \App\Repository\RaportColaboratorRepository::buildSort
    ...
    /**
     * @covers \App\Repository\RaportColaboratorRepository::saveRaportColaboratori
     */
    public function testItCanSaveRaportWithException()
    {
        ...
        $consultatiiRepo = $this->createMock(ConsultatieRepository::class);
        ...
        $em->method('getRepository')
            ->willReturnMap([
                ...
                [User::class, $userRepo],
                [Consultatie::class, $consultatiiRepo],
            ]);
        ...
        $repo = new RaportColaboratorRepository($registry, $em, $service);
    ...
    /**
     * @covers \App\Repository\RaportColaboratorRepository::getRaportByFilters
     */
    ...
    /**
     * @covers \App\Repository\RaportColaboratorRepository::platesteColaborator
     */
    public function testPlatesteColaboratorWithException()
    {
        ...
        $repo = $this->getMockBuilder(RaportColaboratorRepository::class)
    ...
    public function testPlatesteColaboratorWithSuccess()
    {
        ...
        $raport->setStare(RaportColaboratorRepository::STARE_NEPLATITA);
