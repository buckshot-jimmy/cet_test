...
class ConsultatieRepositoryTest extends KernelTestCase
{
    protected function setUp(): void
    {
        ...
        $this->repo = new ConsultatieRepository($registry, $this->em, $this->service);
        ...
        $this->serviciu2 = (new Serviciu())->setDenumire('Consult_Test2');
        ...
        $this->consultatie2 = new Consultatie();
        ...
        $this->dto = new ConsultatieDTO(1, '1', '1', 'C', '10' , '1', 'd',
        ...
        $this->repoMock = $this->getMockBuilder(ConsultatieRepository::class)
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::__construct
     */
    public function testCanBuildConsultatiiRepository()
    {
        $this->assertInstanceOf(ConsultatieRepository::class, $this->repo);
    }

    /**
     * @covers \App\Repository\ConsultatieRepository::getAllConsultatiiByFilter
     * @covers \App\Repository\ConsultatieRepository::applyFilters
     * @covers \App\Repository\ConsultatieRepository::buildSort
     */
    public function testCanGetAllConsultatiiWithoutFilter()
    {
        $filter = ['value' => '', 'propertyFilters' => [], 'length' => 10, 'start' => 0,
            'sort' => ['column' => ConsultatieRepository::COL_NR_INREG, 'dir' => 'DESC']];
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::getAllConsultatiiByFilter
     * @covers \App\Repository\ConsultatieRepository::getTotalConsultatiiByFilter
     * @covers \App\Repository\ConsultatieRepository::applyFilters
     */
    ...
    public function testCanGetAllConsultatiiWithException()
    {
        ...
        $filter = [
            ...
            'propertyFilters' => [],
            'sort' => [
                'column' => ConsultatieRepository::COL_NR_INREG,
                'dir' => 'INVALID_DIR',
            ],
        ];
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::saveConsultatie
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::saveInvestigatie
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::saveEvaluarePsihologica
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::getConsultatieInvestigatieEvaluare
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::getIstoricPacient
     */
    public function testCanGetIstoricPacientWithExceptionAndTipToate()
    {
        $this->expectException(\Exception::class);

        $this->repoMock->getIstoricPacient($this->pacient->getId(), ConsultatieRepository::TIP_TOATE);
    }
    ...
    public function testCanGetIstoricPacient()
    {
        $result = $this->repo->getIstoricPacient($this->pacient->getId(),
            ConsultatieRepository::TIP_CONSULTATIE);

        $this->assertSame($result[0]['id'], $this->consultatie->getId());
    }

    /**
     * @covers \App\Repository\ConsultatieRepository::getIstoricConsultatiiPentruFisa
     */
    public function testCanGetIstoricConsultatiiPentruFisaWithExceptionAndTipToate()
    {
        ...
        $this->repoMock->getIstoricConsultatiiPentruFisa(
            $this->pacient->getId(), $this->medic, ConsultatieRepository::TIP_TOATE);
    }
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::deschideStergeConsultatii
     */
    public function testDeschideConsultatiiWithPersistException()
    {
        ...
        $consMock = $this->getMockBuilder(ConsultatieRepository::class)
            ->setConstructorArgs([$registry, $em, $service])
            ->onlyMethods(['getServiciiPacient', 'findBy', 'find'])
            ->getMock();

        $pretMock = $this->createMock(PretRepository::class);
        $pacientMock = $this->createMock(PacientRepository::class);
        $programareMock = $this->createMock(ProgramareRepository::class);

        $em->method('getRepository')->willReturnMap([
            [Pret::class, $pretMock],
            [Consultatie::class, $consMock],
            [Pacient::class, $pacientMock],
            [Programare::class, $programareMock]
        ]);
    ...
    public function testDeschideConsultatiiWithSuccess()
    {
        ...
        $pret2 = $this->em->getRepository(Pret::class)->findAll()[1];
        $pret3 = $this->em->getRepository(Pret::class)->findAll()[2];
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::getServiciiPacient
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::incaseazaConsultatii
     */
    public function testIncaseazaConsultatiiWithException()
    {
        ...
        $repo = new ConsultatieRepository($registry, $em, $service);
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::calculeazaPlataColaborator
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::getConsultatiiRaportColaborator
     */
    public function testItCanGetConsultatiiRaportColaboratorWithException()
    {
        $this->expectException(\Exception::class);

        $raport = $this->createMock(RaportColaborator::class);
        ...
        $repoMock = $this->getMockBuilder(ConsultatieRepository::class)
            ->setConstructorArgs([$registry, $em, $service])
            ->onlyMethods(['createQueryBuilder'])
            ->getMock();
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::inchideDeschide
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::valoareServicii
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::numarConsultatiiPeLuni
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::getNrPacientiConsultatiDeMedic
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::getNrServiciiPrestateMedic
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::ownerAreConsultatiiDeschise
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::inchideToateConsInvPacient
     */
    public function testInchideToateConsultatiilePacientWithException()
    {
        $this->expectException(\Exception::class);

        $this->repo->inchideToateConsInvPacient(new Pacient());
    }
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::deleteConsultatie
     */
    ...
    /**
     * @covers \App\Repository\ConsultatieRepository::getConsultatiiNefacturatePacient
     */
