...
class ProgramareRepositoryTest extends WebTestCase
{
    protected function setUp(): void
    {
        ...
        $this->repo = new ProgramareRepository($registry, $this->em);
        ...
        $this->serviciu = (new Serviciu())->setDenumire('Consult_TestTest');
    ...
    /**
     * @covers \App\Repository\ProgramareRepository::__construct
     */
    public function testCanBuildPreturiRepository()
    {
        $this->assertInstanceOf(ProgramareRepository::class, $this->repo);
    }
    ...
    /**
     * @covers \App\Repository\ProgramareRepository::getAllProgramari
     */
    public function testItCanGetAllProgramariWithException()
    {
        ...
        $repoMock = $this->getMockBuilder(ProgramareRepository::class)
    ...
    /**
     * @covers \App\Repository\ProgramareRepository::getAllProgramari
     * @covers \App\Repository\ProgramareRepository::getTotalProgramari
     * @covers \App\Repository\ProgramareRepository::applyFilters
     * @covers \App\Repository\ProgramareRepository::buildSort
    ...
    /**
     * @covers \App\Repository\ProgramareRepository::saveProgramare
     */
    ...
    public function testItCanSavePretWithPersistException()
    {
        ...
        $pacienti = $this->createMock(PacientRepository::class);
        $preturi = $this->createMock(PretRepository::class);

        $programareMock = $this->getMockBuilder(ProgramareRepository::class)
            ->setConstructorArgs([$registry, $em])
            ->onlyMethods(['find'])
            ->getMock();

        $em->method('getRepository')->willReturnMap([
            [Pacient::class, $pacienti],
            [Pret::class, $preturi],
        ...
        $pacienti->method('find')->willReturn(new Pacient());
        $preturi->method('find')->willReturn(new Pret());
    ...
    /**
     * @covers \App\Repository\ProgramareRepository::getProgramare
     */
    public function testItCanGetProgramareWithException()
    {
        ...
        $this->repo->getProgramare(new Programare());
    }
    ...
    /**
     * @covers \App\Repository\ProgramareRepository::cancelProgramare
     */
    public function testItCanCancelProgramareWithException()
    {
        ...
        $repo = new ProgramareRepository($registry, $em);
    ...
    /**
     * @covers \App\Repository\ProgramareRepository::checkAvailability
     */
