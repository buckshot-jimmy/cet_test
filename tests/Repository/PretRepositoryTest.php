...
class PretRepositoryTest extends WebTestCase
{
    protected function setUp(): void
    {
        ...
        $this->repo = new PretRepository($registry, $this->em);
    ...
    /**
     * @covers \App\Repository\PretRepository::__construct
     */
    public function testCanBuildPreturiRepository()
    {
        $this->assertInstanceOf(PretRepository::class, $this->repo);
    }
    ...
    /**
     * @covers \App\Repository\PretRepository::getAllPreturi
     */
    public function testItCanGetAllPreturiWithException()
    {
        ...
        $repoMock = $this->getMockBuilder(PretRepository::class)
    ...
    /**
     * @covers \App\Repository\PretRepository::getAllPreturi
     * @covers \App\Repository\PretRepository::getTotalPreturi
     * @covers \App\Repository\PretRepository::applyFilters
     * @covers \App\Repository\PretRepository::buildSort
    ...
    /**
     * @covers \App\Repository\PretRepository::getPreturiMedic
     */
    public function testItCanGetPreturiMedicWithException()
    {
        $this->expectException(\Exception::class);

        $this->repo->getPreturiMedic(new Pret());
    }
    ...
    /**
     * @covers \App\Repository\PretRepository::savePret
     */
    ...
    public function testItCanSavePretWithPersistException()
    {
        ...
        $serviciu = $this->createMock(ServiciuRepository::class);

        $pretMock = $this->getMockBuilder(PretRepository::class)
            ->setConstructorArgs([$registry, $em])
            ->onlyMethods(['find'])
            ->getMock();
        ...
        $serviciu->method('find')->willReturn(new Serviciu());
        ...
        $pretMock->savePret([
            ...
            'pret_serviciu' => $this->em->getRepository(Serviciu::class)->findAll()[0]->getId(),
            'pret_pret' => -10,
    ...
    /**
     * @covers \App\Repository\PretRepository::getPret
     */
    ...
    /**
     * @covers \App\Repository\PretRepository::getMediciForOwner
     */
    ...
    /**
     * @covers \App\Repository\PretRepository::deletePret
     */
    ...
    public function testItCanDeletePretWithSuccess()
    {
        ...
        $serviciu = (new Serviciu())->setDenumire('Consult_TestTest2');
        $serviciu->setTip(0);
