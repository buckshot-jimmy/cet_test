...
/**
 * @extends ServiceEntityRepository<PersoanaJuridica>
 */
class PersoanaJuridicaRepository extends ServiceEntityRepository
{
    public const COL_DENUMIRE = '1';

    public function __construct(ManagerRegistry $registry, private EntityManagerInterface $em)
    {
        parent::__construct($registry, PersoanaJuridica::class);
    }
    ...
    public function saveClientPj($formData)
    {
        ...
        if(!$pj instanceof PersoanaJuridica) {
    ...
    {
        $pj = $this->em->getRepository(PersoanaJuridica::class)->find($id);
