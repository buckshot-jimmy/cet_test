...
/**
 * @method RaportColaborator|null find($id, $lockMode = null, $lockVersion = null)
 * @method RaportColaborator|null findOneBy(array $criteria, array $orderBy = null)
 * @method RaportColaborator[]    findAll()
 * @method RaportColaborator[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class RaportColaboratorRepository extends ServiceEntityRepository
{
    ...
    {
        parent::__construct($registry, RaportColaborator::class);
    }
    ...
    public function getAllRapoarteColaboratori($filter)
    {
        ...
        foreach ($rapoarteColaboratori as &$raportColaborator) {
            $raport = $this->em->getRepository(RaportColaborator::class)->find($raportColaborator['id']);
    ...
    {
        $raportColaboratori = new RaportColaborator();
        $date = new \DateTime();
        ...
        $raportColaboratori->setSuma($this->em->getRepository(Consultatie::class)
