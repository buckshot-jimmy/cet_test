...
class FacturaController extends AbstractController
{
    ...
    {
        if (!$this->authorizationChecker->isGranted('VIEW', new Factura())) {
    ...
    public function list(Request $request): Response
    {
        ...
        $facturi = $this->em->getRepository(Factura::class)->getAllFacturi($filter);
    ...
    {
        if (!$this->authorizationChecker->isGranted('ADD', new Factura())) {
            throw new AccessDeniedException();
        }
        ...
        $this->em->getRepository(Factura::class)->saveInvoice($invoice);
    ...
    public function storneaza(Request $request): JsonResponse
    {
        ...
        $factura = $this->em->getRepository(Factura::class)->find($request->request->get('factura_id'));

        if ($factura->getStornare() instanceof Factura) {
            return new JsonResponse([
                'status' => Response::HTTP_BAD_REQUEST,
        ...
        $this->em->getRepository(Factura::class)->storneaza($factura);
    ...
    public function consultatiiNefacturateList(Request $request)
    {
        ...
        $data = $this->em->getRepository(Pacient::class)->getPacientiConsultatiiNefacturate($filter);
    ...
    {
        $serviciiPacient = $this->em->getRepository(Consultatie::class)
