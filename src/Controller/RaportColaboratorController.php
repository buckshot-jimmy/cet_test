...
class RaportColaboratorController extends AbstractController
{
    ...
    {
        if (!$this->authorizationChecker->isGranted('VIEW', new RaportColaborator())) {
    ...
    public function listRapoarteColaboratori(Request $request) : Response
    {
        ...
        $rapoarteColaboratori = $this->em->getRepository(RaportColaborator::class)
    ...
    public function saveRapoarteColaboratori(Request $request) : Response
    {
        ...
        if (!$this->authorizationChecker->isGranted('ADD_EDIT', new RaportColaborator())) {
            throw new AccessDeniedException();
        }

        $raportId = $this->em->getRepository(RaportColaborator::class)->saveRaportColaboratori($formData);
    ...
    public function calculeazaPlataColaborator(Request $request) : Response
    {
        ...
        $raport = $this->em->getRepository(RaportColaborator::class)->getRaportByFilters($formData);

        $totalDePlata = $this->em->getRepository(Consultatie::class)->calculeazaPlataColaborator($formData);
    ...
    public function platesteColaborator(Request $request) : Response
    {
        ...
        $this->em->getRepository(RaportColaborator::class)->platesteColaborator($formData);
    ...
    public function getColaboratoriOwner(Request $request) : Response
    {
        ...
        $data = $this->em->getRepository(Pret::class)->getMediciForOwner($ownerId);
