...
class ServiciuPretController extends AbstractController
{
    ...
    {
        if (!$this->authorizationChecker->isGranted('DELETE', new Serviciu())) {
            throw new AccessDeniedException();
        }

        $this->em->getRepository(Pret::class)->deletePret($request->request->get('id'));
    ...
    public function salveazaServiciu(Request $request) : Response
    {
        ...
        if (!$this->authorizationChecker->isGranted('ADD_EDIT', new Serviciu())) {
            throw new AccessDeniedException();
        }

        $this->em->getRepository(Serviciu::class)->saveServiciu($formData);
    ...
    public function salveazaPret(Request $request) : Response
    {
        ...
        if (!$this->authorizationChecker->isGranted('ADD_EDIT', new Pret())) {
            throw new AccessDeniedException();
        }
        ...
        $this->em->getRepository(Pret::class)->savePret($formData);
    ...
    {
        $pretData = $this->em->getRepository(Pret::class)->getPret($request->query->get('id'));
    ...
    public function getPreturiForMedic(Request $request): Response
    {
        ...
        $preturi = $this->em->getRepository(Pret::class)->getPreturiMedic($medic);
