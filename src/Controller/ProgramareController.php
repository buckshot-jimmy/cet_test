...
class ProgramareController extends AbstractController
{
    ...
    public function list(Request $request) : Response
    {
        ...
        $programari = $this->em->getRepository(Programare::class)->getAllProgramari($filter);
    ...
    public function adaugaProgramare(Request $request): Response
    {
        ...
        if ($formData['programare_id']) {
            $attribute = 'EDIT';
            $subject = $this->em->getRepository(Programare::class)->findOneBy(['id' => $formData['programare_id']]);
        }
        ...
        $this->em->getRepository(Programare::class)->saveProgramare($formData, $this->getUser());
    ...
    {
        $data = $this->em->getRepository(Programare::class)->getProgramare($request->query->get('id'));
    ...
    {
        $subject = $this->em->getRepository(Programare::class)->findOneBy(['id' => $request->request->get('id')]);

        if (!$this->authorizationChecker->isGranted('CANCEL', $subject)) {
            throw new AccessDeniedException();
        }

        $this->em->getRepository(Programare::class)->cancelProgramare($request->request->get('id'));
    ...
    public function pacientAnuleazaProgramare(Request $request) : Response
    {
        ...
        if (!$form->isSubmitted()) {
            ...
            $programare = $this->em->getRepository(Programare::class)->findOneBy(['id' => $programareId]);
        }
        ...
        if ($form->isSubmitted()) {
            ...
            $this->em->getRepository(Programare::class)->cancelProgramare($request->request->get('programareId'));
    ...
    public function verificaDisponibilitate(Request $request) : Response
    {
        ...
        $free = $this->em->getRepository(Programare::class)->checkAvailability($formData);
