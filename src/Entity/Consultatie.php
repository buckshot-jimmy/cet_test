...
class Consultatie
{
    ...
    #[ORM\ManyToOne(targetEntity: "App\Entity\Pacient", inversedBy: "consultatii")]
    ...
    #[ORM\Column(type: "boolean", nullable: false,
        options: ["after" => "incasata", "default" => "0", "comment" => "0-neplatita,1-platita"])]
    ...
    #[ORM\ManyToOne(targetEntity: Programare::class, inversedBy: 'consultatii')]
    ...
    #[ORM\Column(type: "boolean", nullable: false, options: ["default" => "0", "comment" => "1-facturata"])]
    private ?bool $facturata = false;
    ...
    public function getProgramare(): ?Programare
    {
        return $this->programare;
    }

    public function setProgramare(?Programare $programare): static
    {
    ...
    public function isFacturata(): ?bool
    {
        return $this->facturata;
    }

    public function setFacturata(?bool $facturata): static
    {
