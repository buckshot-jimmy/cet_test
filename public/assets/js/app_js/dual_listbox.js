(function(factory) {
    ...
    var pluginName = 'bootstrapDualListbox',
        defaults = {
            filterTextClear: 'arată toate',
            filterPlaceHolder: 'Filtrează',
            moveSelectedLabel: 'Mută opțiunea',
            moveAllLabel: 'Mută toate',
            removeSelectedLabel: 'Șterge opțiunea',
            removeAllLabel: 'Șterge toate',
            ...
            infoText: 'Arată toate {0}',                                                        // text when all options are visible / false for no info text
            infoTextFiltered: '<span class="badge badge-success">Filtrate</span> {0} din {1}', // when not all of the options are visible due to the filter
            infoTextEmpty: 'Listă goală',                                                        // when there are no options present in the list
