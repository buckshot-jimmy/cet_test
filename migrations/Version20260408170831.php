...
final class Version20260408170831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE owners ADD adresa VARCHAR(255) NOT NULL, ADD cont_bancar VARCHAR(34) DEFAULT NULL, ADD banca VARCHAR(50) DEFAULT NULL, ADD serie_factura VARCHAR(10) NOT NULL, ADD reg_com VARCHAR(25) DEFAULT NULL, ADD capital_social INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE owners DROP adresa, DROP cont_bancar, DROP banca, DROP serie_factura, DROP reg_com, DROP capital_social');
    }
}
