...
final class Version20201028201845 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE owners CHANGE denumire denumire VARCHAR(100) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE owners CHANGE denumire denumire VARCHAR(30) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`');
