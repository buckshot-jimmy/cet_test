 ...
 */
final class Version20201101212635 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B92EC8C2450C75AA ON medici_trimitatori (nume)');
        $this->addSql('ALTER TABLE pacienti CHANGE cnp cnp VARCHAR(13) NOT NULL, CHANGE judet judet VARCHAR(50) DEFAULT NULL, CHANGE loc_munca loc_munca VARCHAR(50) DEFAULT NULL, CHANGE ocupatie ocupatie VARCHAR(50) DEFAULT NULL, CHANGE data_inreg data_inreg DATETIME DEFAULT NULL, CHANGE telefon2 telefon2 VARCHAR(20) DEFAULT NULL, CHANGE email email VARCHAR(50) DEFAULT NULL, CHANGE localitate localitate VARCHAR(50) DEFAULT NULL, CHANGE observatii observatii VARCHAR(500) DEFAULT NULL');
