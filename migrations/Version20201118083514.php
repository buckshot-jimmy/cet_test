 ...
 */
final class Version20201118083514 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE consultatii CHANGE diagnostic diagnostic VARCHAR(3000) NOT NULL, CHANGE consultatie consultatie VARCHAR(3000) NOT NULL, CHANGE tratament tratament VARCHAR(3000) NOT NULL, CHANGE zile_cm zile_cm INT DEFAULT NULL COMMENT \'nr. zile c.m.\', CHANGE certif_cm certif_cm VARCHAR(20) DEFAULT NULL COMMENT \'certif. c.m.\', CHANGE medic_trimitator medic_trimitator VARCHAR(30) DEFAULT NULL, CHANGE ahc ahc VARCHAR(1000) DEFAULT NULL, CHANGE app app VARCHAR(1000) DEFAULT NULL, CHANGE platita_colaborator platita_colaborator TINYINT(1) DEFAULT \'0\' NOT NULL COMMENT \'0-neplatita,1-platita\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE consultatii CHANGE diagnostic diagnostic VARCHAR(500) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE consultatie consultatie VARCHAR(500) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE tratament tratament VARCHAR(500) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE ahc ahc VARCHAR(500) CHARACTER SET utf8 DEFAULT \'NULL\' COLLATE `utf8_general_ci`, CHANGE app app VARCHAR(500) CHARACTER SET utf8 DEFAULT \'NULL\' COLLATE `utf8_general_ci`, CHANGE zile_cm zile_cm INT DEFAULT NULL COMMENT \'nr. zile c.m.\', CHANGE certif_cm certif_cm VARCHAR(20) CHARACTER SET utf8 DEFAULT \'NULL\' COLLATE `utf8_general_ci` COMMENT \'certif. c.m.\', CHANGE platita_colaborator platita_colaborator TINYINT(1) DEFAULT \'0\' NOT NULL COMMENT \'0-neplatita,1-platita\', CHANGE medic_trimitator medic_trimitator VARCHAR(30) CHARACTER SET utf8 DEFAULT \'NULL\' COLLATE `utf8_general_ci`');
