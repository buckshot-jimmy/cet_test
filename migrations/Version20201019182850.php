...
final class Version20201019182850 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE owners (id INT AUTO_INCREMENT NOT NULL, denumire VARCHAR(30) NOT NULL, cui VARCHAR(10) NOT NULL, sters TINYINT(1) DEFAULT \'0\' NOT NULL COMMENT \'0-nesters,1-sters\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE preturi ADD CONSTRAINT FK_F93C045A7E3C61F9 FOREIGN KEY (owner_id) REFERENCES owners (id)');
